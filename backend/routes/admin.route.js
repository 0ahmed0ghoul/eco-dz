...
//organizer routes
router.get('/agencies',getAllOrganizers); 
router.post('/agencies/:id/approve', approveOrganizer); // approve  agencies
router.delete('/agencies/:id/delete', rejectOrganizer); // reject agencies
