...
const AdminDashboard = () => {
  ...
  const fetchOrganizers = async () => {
    ...
    try {
      ...
      const pendingOrganizers = (data.agencies || []).filter(
        (org) => org.verified === 0
      );
        ...
        <div className="flex justify-between items-center mb-6 p-4 bg-white rounded-xl shadow-sm border border-gray-200">
          <div className="flex gap-3">
            <button
              ...
              className="px-4 py-2 bg-linear-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition-all flex items-center gap-2"
            >
          ...
          <div className="mb-6 p-6 bg-white rounded-xl shadow-lg border border-blue-100 animate-fadeIn">
            ...
            <div className="flex justify-end gap-3 mt-4">
              ...
              <button
                ...
                className="px-6 py-2 bg-linear-to-r from-blue-600 to-blue-700 text-white rounded-lg hover:from-blue-700 hover:to-blue-800 transition"
              >
                Add Place
              </button>
            </div>
          ...
          {tabs.map((tab) => (
            <button
              ...
              className={`flex-1 py-3 px-4 rounded-lg flex items-center justify-center gap-3 transition-all ${
                activeTab === tab.id
                  ? "bg-linear-to-r from-blue-50 to-blue-100 text-blue-700 border border-blue-200 shadow-inner"
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-3">
                      <button
                        ...
                        className="px-4 py-2 bg-linear-to-r from-green-500 to-emerald-600 text-white rounded-lg hover:from-green-600 hover:to-emerald-700 transition flex items-center gap-2"
                      >
                        <FaCheck /> Approve
                      </button>
                      <button
                        onClick={() => handleRejectTrip(trip.id, trip.title)}
                        className="px-4 py-2 bg-linear-to-r from-red-500 to-red-600 text-white rounded-lg hover:from-red-600 hover:to-red-700 transition flex items-center gap-2"
                      >
                        <FaTimes /> Reject
                      </button>
                    </div>
              ...
              {activeTab === "porganizers" && sortedData(porganizers).map((org) => (
                <div key={org.id} className="px-6 py-4 hover:bg-yellow-50/50 transition-colors">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex gap-3">
                      <button
                        onClick={() => handleApproveOrganizer(org.id, org.username)}
                        className="px-4 py-2 bg-linear-to-r from-green-500 to-emerald-600 text-white rounded-lg hover:from-green-600 hover:to-emerald-700 transition flex items-center gap-2"
                      >
                        <FaCheck /> Approve
                      </button>
                      <button
                        onClick={() => handleRejectOrganizer(org.id, org.username)}
                        className="px-4 py-2 bg-linear-to-r from-red-500 to-red-600 text-white rounded-lg hover:from-red-600 hover:to-red-700 transition flex items-center gap-2"
                      >
                        <FaTimes /> Reject
                      </button>
