    ...
    const fetchUserAndActivity = async () => {
      try {
        ...
        const [favRes, comRes, rateRes] = await Promise.all([
          ...
          fetch("http://localhost:5000/api/user/comments", {
            headers: { Authorization: `Bearer ${token}` },
          }),
                ...
                {activeTab === "comments" && (
                  <div className="bg-white rounded-2xl shadow-lg overflow-hidden border border-gray-100">
                    <div className="p-6 border-b border-gray-100">
                      ...
                      <p className="text-gray-600 mt-1">
                        Reviews and feedback you've shared
                      </p>
                    </div>
                    <div className="p-6">
                      {comments.length === 0 ? (
                        <div className="text-center py-12">
                          ...
                          <p className="text-gray-500">
                            Share your thoughts on places you've visited!
                          </p>
                        </div>
                      ) : (
                    ...
                    <div className="p-6">
                      {ratings.length === 0 ? (
                        <div className="text-center py-12">
                          ...
                          <p className="text-gray-500">
                            Rate places to help other travelers!
                          </p>
                        </div>
                      ) : (
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
