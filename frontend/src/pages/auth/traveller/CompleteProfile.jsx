...
const CompleteProfile = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log("Response:", profileRes.status, profileData); // Debug log
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              ...
              <div className="text-center">
                ...
                <div className="relative inline-block">
                  <div className="w-40 h-40 mx-auto rounded-full border-4 border-white shadow-xl overflow-hidden bg-gradient-to-br from-blue-100 to-purple-100">
                    {avatarPreview ? (
                      <motion.img
                        initial={{ scale: 0.8 }}
                        animate={{ scale: 1 }}
                  ...
                  <div className="mt-6">
                    ...
                    <label
                      ...
                      className="inline-flex items-center gap-2 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-600 text-white rounded-xl hover:from-blue-600 hover:to-purple-700 transition-all duration-300 cursor-pointer shadow-lg hover:shadow-xl"
                    >
                      <FaUpload />
              ...
              <div className="pt-4">
                <motion.button
                  ...
                  type="submit"
                  disabled={isLoading}
                  className="w-full flex items-center justify-center gap-3 px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-2xl font-semibold text-lg shadow-lg hover:shadow-xl transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {isLoading ? (
                    <>
                      <motion.div
