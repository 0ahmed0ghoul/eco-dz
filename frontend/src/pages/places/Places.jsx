...
export default function Places() {
  ...
  useEffect(() => {
    const fetchCategories = async () => {
      try {
        const res = await fetch(`${import.meta.env.VITE_API_URL}/api/places/categories`);
          ...
          {categories.map((cat) => {
            ...
            return (
              <div
                ...
                onMouseEnter={() => handleMouseEnter(cat.category, images)} // ✅ Pass parsed images
                onMouseLeave={() => handleMouseLeave(cat.category, images)} // ✅ Pass parsed images
              >
                {/* BACKGROUND GRADIENT */}
                <div
                ...
                {currentImage && (
                  <img
                    src={currentImage} // ✅ Access the url property
                    alt={cat.category}
