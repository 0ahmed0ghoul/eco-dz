...
const travelOffers = [
  ...
  },
  {
    ...
    duration: "4 days",
    image:
      "https://images.unsplash.com/photo-1589330694652-d53bf3e11ff0?auto=format&fit=crop&w=1000&q=80",
    description:
  ...
  },
  {
    ...
    duration: "2 days",
    image:
      "https://images.unsplash.com/photo-1594736797933-d0401ba94693?auto=format&fit=crop&w=1000&q=80",
    description:
  ...
  },
  {
    ...
    description: "Wetlands and lakes ecosystem with exceptional bird watching.",
  },
  {
    id: 6,
    ...
    duration: "4 days",
    image:
      "https://images.unsplash.com/photo-1464822759849-e41fc6e4c6b3?auto=format&fit=crop&w=1000&q=80",
    description:
...
function Travel() {
  return (
    <section
      className="relative min-h-screen py-10 px-4 sm:px-6 lg:px-8 bg-gray-900"
      id="travels"
    >
      <div className="text-center mb-8">
        ...
        <p className="text-lg sm:text-xl text-white/90 font-light">
          Explore the breathtaking national parks and ecological monuments of
          Algeria
        </p>
      </div>
      ...
      <div className="overflow-hidden relative">
        <div className="flex animate-marquee gap-6">
          {travelOffers.concat(travelOffers).map((offer, index) => (
            <div
              key={index}
              className="min-w-[280px] max-w-[360px] bg-white rounded-2xl shadow-lg cursor-pointer overflow-hidden flex flex-col"
            >
              <div className="relative h-56 overflow-hidden rounded-t-2xl">
                ...
                />
                <div className="absolute bottom-3 left-3 bg-linear-to-r from-red-500 to-orange-500 text-white px-4 py-1 rounded-lg font-semibold text-sm">
              ...
              <div className="p-4 flex flex-col h-full">
                ...
                <button className="w-full mt-auto bg-linear-to-r from-indigo-500 to-purple-600 text-white font-semibold py-2 rounded-xl shadow-md hover:shadow-lg transition-all duration-300">
                  View Details
                </button>
              </div>
            </div>
