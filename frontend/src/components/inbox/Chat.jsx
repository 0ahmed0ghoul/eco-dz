...
import { Send, Phone, FileText, Clock } from "lucide-react";
import { io } from "socket.io-client";

export default function Chat({ conversationId, otherUserName, otherUserId }) {
  ...
  useEffect(() => {
    ...
    socketRef.current.emit("user-online", JSON.parse(localStorage.getItem("user")).id);
  ...
  const handleSendMessage = (e) => {
    ...
    setNewMessage("");
    socketRef.current.emit("stop-typing", { conversationId, userId: user.id });
  };
